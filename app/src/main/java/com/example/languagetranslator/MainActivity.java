...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"From","English","Hindi","Marathi","Tamil","Telugu","Chinese","Japanese","French","Spanish","German","Irish","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech","Greek","Kannada","Welsh","Urdu"};
    String[] toLanguages = {"To","English","Hindi","Marathi","Tamil","Telugu","Chinese","Japanese","French","Spanish","German","Irish","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech","Greek","Kannada","Welsh","Urdu"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //To show the list of From languages
        ...
        //To show the list of To languages
        ...
        translateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(MainActivity.this,"Please select language for translation",Toast.LENGTH_SHORT).show();
                }
                else
                {
